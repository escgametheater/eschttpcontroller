console.log("Loading beespro.js");
...
var BeesPro = {
    ...
    controllerName: "Bee Racing Pro",
    gameId: "beespro",
    teamColors: ["red","gold"],
    teamTextColors: ["red","gold"],
    teamNames: ["Red Team","Yellow Team"],
    backgroundImage: "url('games/beespro/beespro_background.jpg')",
    teamid: -1 ,
    autojoin: true ,
    lastAcc: {x:0,y:0,z:0} ,
    ...
    onMessage: function (ev,params) {
        ...
        console.log("onMessage unhandled: '"+ev+"'");
        return true ;
    },
...
playerControllers.beespro = BeesPro ;

console.log("Done loading beespro.js");
