...
Strophe.Connection.prototype = {
    ...
    */
    ...
    _dataRecv: function (req, raw) {
        ...
        if (elem === null) { Strophe.info("elem is null"); return; }
        ...
        Strophe.info("sending to handlers");
        ...
        Strophe.forEachChild(elem, null, function (child) {
            ...
            for (i = 0; i < newList.length; i++) {
                ...
                try {
                    //Strophe.info("isMatch:  " + hand.isMatch(child) + " authenticated: " + that.authenticated + "hand.user: " + hand.user);
                    if (hand.isMatch(child)
                        // The next line is commented out because it does not allow a handler to get called if an unauthenticated user is trying to register
                        // Bug?
